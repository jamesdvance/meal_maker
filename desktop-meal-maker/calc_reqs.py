...
def calc_cal(tdee):
	cal_dict = {-1.0:-500, -0.5:-250 , 0.0:0,  0.5:250, 1.0:500 , 2.0:1000}

	goal = float(input("How would you like your weight to change this week? [Choose between -1,-.5, 0, .5, 1, 2] "))
	cal_adj = cal_dict[goal]
	cal_req = tdee + cal_adj
	print("I'm recommending a calorie amount of "+str(round(tdee,0))+" adjusted by "+str(cal_adj)+". Your total calorie requirement is "+str(round(cal_req,0))+".")
